...
def sprout_leaves(t, values):
    ...
    for branch in branches(t):
        new_branches.append(sprout_leaves(branch, values))
...
def add_chars(w1, w2):
    ...
    if w1[0] == w2[0]: return add_chars(w1[1:], w2[1:])
    if w1[0] != w2[0]: return w2[0] + add_chars(w1, w2[1:])
...
def add_trees(t1, t2):
    ...
    len_t1 = len(branches(t1))
    len_t2 = len(branches(t2))
    if len_t1 > len_t2:
        for branch in branches(t1)[len_t2:]:
            new_branches.append(branch)
    elif len_t1 < len_t2:
        for branch in branches(t2)[len_t1:]:
            new_branches.append(branch)
